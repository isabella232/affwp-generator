...
namespace Affiliate_WP_Generator\Utilities;
...
class Basic_Logger extends Logger {
	...
	public function __construct() {
		...
		$this->log_dir = trailingslashit( trailingslashit( $upload_dir['basedir'] ) . 'affwp_generator-event-logs/' );
